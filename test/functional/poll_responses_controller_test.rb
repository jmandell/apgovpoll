...
class PollResponsesControllerTest < ActionController::TestCase
  ...
  test "should create poll_response" do
    assert_difference('PollResponse.count') do
      post :create, poll_response: { age: @poll_response.age, canidate: @poll_response.canidate, gender: @poll_response.gender, location: @poll_response.location }
    end
  ...
  test "should update poll_response" do
    put :update, id: @poll_response, poll_response: { age: @poll_response.age, canidate: @poll_response.canidate, gender: @poll_response.gender, location: @poll_response.location }
    assert_redirected_to poll_response_path(assigns(:poll_response))
  end
